...
export type TemplateId = "classic" | "modern" | "boho" | "avantgarde" | "minimal" | "echo";
...
export const templateTokens: Record<TemplateId, TemplateTokens> = {
  classic: {
    ...
    font: "serif",
    page: {
      bg: "bg-[var(--wedding-secondary)]",
    },
    hero: {
      overlay: "from-black/60 via-black/30 to-[var(--wedding-secondary)]",
    ...
    rsvp: {
      section: "bg-[var(--wedding-secondary)] py-32 border-t border-[var(--wedding-primary)]/10",
    ...
    location: {
      section: "bg-[color-mix(in_srgb,var(--wedding-primary)_4%,transparent)]",
    ...
    countdown: {
      section: "bg-[var(--wedding-secondary)]",
  ...
  modern: {
    ...
    hero: {
      overlay: "from-black/50 via-black/20 to-[var(--wedding-secondary)]",
      ...
      button: "px-12 py-7 text-xs tracking-[0.4em] uppercase font-bold transition-all rounded-none ring-1 ring-[var(--wedding-primary)]/20 hover:ring-[var(--wedding-primary)]/60 bg-[var(--wedding-primary)] text-[var(--wedding-secondary)] hover:opacity-90",
      shell: "",
    ...
    rsvp: {
      section: "bg-[color-mix(in_srgb,var(--wedding-primary)_4%,var(--wedding-secondary))] py-32",
    ...
    gallery: {
      ...
      title: "text-[var(--wedding-primary)]",
    },
    location: {
      section: "bg-[color-mix(in_srgb,var(--wedding-primary)_4%,var(--wedding-secondary))]",
      card: "bg-[var(--wedding-secondary)] border border-[var(--wedding-primary)]/10 rounded-none p-8",
      title: "text-[var(--wedding-primary)]",
    },
    schedule: {
      section: "bg-[var(--wedding-secondary)]",
      card: "border border-[var(--wedding-primary)]/10 rounded-none p-8 bg-[var(--wedding-secondary)]",
      title: "text-[var(--wedding-primary)]",
      time: "text-[var(--wedding-primary)]/60",
    },
    gifts: {
      section: "bg-[color-mix(in_srgb,var(--wedding-primary)_4%,var(--wedding-secondary))]",
      card: "rounded-none border border-[var(--wedding-primary)]/10 bg-[var(--wedding-secondary)] shadow-sm",
      title: "text-[var(--wedding-primary)]",
      text: "text-[var(--wedding-primary)]",
      description: "text-[var(--wedding-primary)]/60",
      badge: "bg-[var(--wedding-secondary)] text-[var(--wedding-primary)]/60",
      progress: "bg-[var(--wedding-primary)]",
      progressTrack: "bg-[var(--wedding-primary)]/20",
    },
    cagnotte: {
      section: "bg-[var(--wedding-secondary)]",
      title: "text-[var(--wedding-primary)]",
      icon: "text-[var(--wedding-primary)]/40",
    },
    countdown: {
      section: "bg-[var(--wedding-secondary)]",
      box: "w-18 h-18 md:w-22 md:h-22 rounded-none bg-[var(--wedding-secondary)] border border-[var(--wedding-primary)]/10",
      number: "text-2xl md:text-3xl font-sans font-black text-[var(--wedding-primary)]",
  ...
  boho: {
    ...
    hero: {
      overlay: "from-black/40 via-transparent to-[var(--wedding-secondary)]",
      wrapper: "text-center max-w-4xl space-y-8",
    ...
    rsvp: {
      section: "bg-[var(--wedding-secondary)] py-32",
      card: "border-none shadow-[0_15px_50px_rgba(0,0,0,0.04)] bg-white rounded-[2.5rem] p-12 md:p-16",
      label: "text-xs uppercase tracking-widest font-medium text-[var(--wedding-primary)]/60",
      input: "h-14 rounded-2xl bg-[color-mix(in_srgb,var(--wedding-primary)_4%,var(--wedding-secondary))] border-none text-[var(--wedding-primary)] placeholder:text-[var(--wedding-primary)]/40 focus:ring-[var(--wedding-primary)]/20",
      title: "text-4xl md:text-5xl font-serif text-[var(--wedding-primary)]",
      description: "text-[var(--wedding-primary)]/60",
    },
    story: {
    ...
    gifts: {
      ...
      text: "text-[var(--wedding-primary)]",
      description: "text-[var(--wedding-primary)]/60",
      badge: "bg-[color-mix(in_srgb,var(--wedding-primary)_4%,var(--wedding-secondary))] text-[var(--wedding-primary)]/60",
      progress: "bg-[var(--wedding-primary)]",
      progressTrack: "bg-[color-mix(in_srgb,var(--wedding-primary)_4%,var(--wedding-secondary))]",
    },
    cagnotte: {
      section: "bg-[color-mix(in_srgb,var(--wedding-primary)_4%,var(--wedding-secondary))]",
      title: "text-[var(--wedding-primary)]",
      icon: "text-[var(--wedding-primary)]/60",
    },
    countdown: {
      section: "bg-[var(--wedding-secondary)]",
  ...
  "echo": {
    ...
    hero: {
      overlay: "from-[var(--wedding-secondary)]/40 via-[var(--wedding-secondary)]/10 to-[var(--wedding-secondary)]/70",
      wrapper: "text-center max-w-[80vw] h-full flex flex-col justify-center items-center",
      title: "text-6xl md:text-[10rem] font-light text-[var(--wedding-primary)] leading-[0.9] tracking-tight",
      subtitle: "text-sm md:text-base tracking-[0.4em] uppercase text-[var(--wedding-primary)]/80 mb-8",
      date: "text-xl md:text-2xl font-light text-[var(--wedding-primary)]/80 mt-12 tracking-[0.2em] border-t border-[var(--wedding-primary)]/20 pt-8",
      button: "px-10 py-5 text-xs tracking-widest uppercase font-medium transition-all bg-stone-900 text-white hover:bg-stone-800 rounded-full",
      shell: "mix-blend-normal",
    ...
    rsvp: {
      section: "py-0 px-0",
      card: "bg-white border-none rounded-[2rem] p-10 md:p-16 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.06)]",
      label: "text-xs uppercase tracking-widest font-semibold text-stone-400 font-sans",
      input: "h-14 rounded-xl bg-stone-50 border-transparent text-stone-900 placeholder:text-stone-300 focus:bg-white focus:border-stone-200 focus:ring-4 focus:ring-stone-100",
      title: "text-4xl md:text-6xl font-light text-stone-900 tracking-tight leading-tight mb-4",
      description: "text-stone-500 text-lg",
    },
    story: {
      title: "text-5xl md:text-7xl font-light text-stone-900 tracking-tight mb-16",
      layout: "flex flex-col md:flex-row gap-16 md:gap-24 items-center",
      image: "rounded-[2rem] shadow-2xl",
      container: "max-w-6xl",
      body: "text-lg md:text-2xl text-stone-600 leading-relaxed font-light",
    },
    gallery: {
      section: "bg-[var(--wedding-secondary)] py-32",
      imageRadius: "rounded-2xl",
      title: "text-[var(--wedding-primary)] text-center pb-16 font-light text-4xl md:text-6xl tracking-tight",
    },
    location: {
      section: "bg-[color-mix(in_srgb,var(--wedding-primary)_2%,var(--wedding-secondary))]",
      card: "bg-[var(--wedding-secondary)] border-none rounded-[2rem] p-10 shadow-sm",
      title: "text-[var(--wedding-primary)]",
    },
    schedule: {
      section: "bg-[color-mix(in_srgb,var(--wedding-primary)_6%,var(--wedding-secondary))]",
      card: "border-none rounded-[2rem] p-10 bg-[var(--wedding-secondary)] shadow-sm",
      title: "text-[var(--wedding-primary)]",
      time: "text-[var(--wedding-primary)]/70 font-medium",
    },
    gifts: {
      section: "py-0 px-0",
      card: "rounded-[2rem] border-none bg-[var(--wedding-secondary)] shadow-[0_8px_40px_-12px_rgba(0,0,0,0.08)]",
      title: "text-[var(--wedding-primary)]",
      text: "text-[var(--wedding-primary)]",
      description: "text-[var(--wedding-primary)]/70",
      badge: "bg-[var(--wedding-primary)]/10 text-[var(--wedding-primary)]/80",
      progress: "bg-[var(--wedding-primary)]",
      progressTrack: "bg-[var(--wedding-primary)]/10",
    },
    cagnotte: {
      section: "bg-[color-mix(in_srgb,var(--wedding-primary)_6%,var(--wedding-secondary))]",
      title: "text-[var(--wedding-primary)]",
    ...
    countdown: {
      section: "bg-white",
      box: "w-24 h-24 rounded-2xl bg-stone-50 border-none",
      number: "text-4xl font-light text-stone-900",
      label: "text-[10px] text-stone-400 mt-2 uppercase tracking-widest",
    },
    footer: {
      section: "bg-stone-900 text-white/50",
    },
  },
};
