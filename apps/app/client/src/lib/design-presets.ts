...
export const TEMPLATE_PRESETS = {
  ...
  echo: {
    id: "echo",
    name: "Écho",
    description: "Expérience visuelle immersive et pure.",
    defaultFont: "sans",
  ...
  velours: {
    id: "velours",
    name: "Velours Noir",
    description: "Luxe sombre et accents dorés",
    defaultFont: "serif",
    defaultButtonStyle: "outline",
    defaultButtonRadius: "square",
  },
  soleil: {
    id: "soleil",
    name: "Soleil",
    description: "Clair, aéré et naturel",
    defaultFont: "sans",
    defaultButtonStyle: "solid",
    defaultButtonRadius: "pill",
  },
  graphik: {
    id: "graphik",
    name: "Graphik",
    description: "Typographie forte et éditorial",
    defaultFont: "sans",
    defaultButtonStyle: "solid",
    defaultButtonRadius: "square",
  },
