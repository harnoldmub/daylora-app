...
import { Check, Crown, Loader2, Infinity } from "lucide-react";
			...
			<div className="grid md:grid-cols-3 gap-8">
				...
				<Card className="p-8 relative overflow-hidden border-dashed">
					<div className="absolute top-4 right-4 text-primary/10">
						<Infinity className="h-20 w-20" />
					</div>
					<div className="space-y-6">
						<div>
							<h3 className="text-2xl font-bold">Accès à vie</h3>
						...
						<ul className="space-y-3">
							...
							<Feature text="Accès permanent" checked />
							<Feature text="Pas d'abonnement" checked />
						...
						>
							{checkoutMutation.isPending && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
							{isPremium ? "Déjà Premium" : "Acheter — 149€"}
						</Button>
						<p className="text-center text-xs text-muted-foreground">
