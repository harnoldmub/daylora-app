                                                    ...
                                                    <FormItem className="md:col-span-2">
                                                        ...
                                                        <FormControl>
                                                            <div className="relative">
                                                                ...
                                                                <Input placeholder="Ex: Alex & Sam 2026" {...field} className="glass-morphism border-white/10 h-14 pl-12 focus:border-primary/50 transition-colors text-lg font-serif text-white placeholder:text-white/30" />
                                                            </div>
                                                        </FormControl>
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <div className="flex items-center">
                                                            <div className="glass-morphism border-white/10 border-r-0 px-4 h-14 flex items-center text-xs text-white/40 font-mono rounded-l-xl">daylora.app/</div>
                                                            <FormControl>
